"""
Configuration constants for the scraper module.

This file centralizes settings related to network requests, target URLs,
and the list of leagues to be scraped. Path-related configurations
are managed by `src.utils.paths`.
"""
